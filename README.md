...
_See code: [src/commands/kc/diff.ts](https://github.com/k-capehart/kc-sf-plugin/blob/1.4.5/src/commands/kc/diff.ts)_
...
_See code: [src/commands/kc/trigger-framework.ts](https://github.com/k-capehart/kc-sf-plugin/blob/1.4.5/src/commands/kc/trigger-framework.ts)_
<!-- commandsstop -->
