...
_See code: [src/commands/kc/diff.ts](https://github.com/k-capehart/kc-sf-plugin/blob/1.4.17/src/commands/kc/diff.ts)_
...
_See code: [src/commands/kc/trigger-framework.ts](https://github.com/k-capehart/kc-sf-plugin/blob/1.4.17/src/commands/kc/trigger-framework.ts)_
...
_See code: [src/commands/kc/update-api.ts](https://github.com/k-capehart/kc-sf-plugin/blob/1.4.17/src/commands/kc/update-api.ts)_
<!-- commandsstop -->
